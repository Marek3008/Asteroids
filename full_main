...
"Game constants"
ACCELERATION = 200  # Zrýchlenie rakety
...
class Spaceship(SpaceObject):
    ...
    def __init__(self, sprite, x, y):
        ...
        # flame sprity
        flame_sprite = pyglet.image.load("Assetss/PNG/Effects/fire14.png")
    ...
    def shoot(self):
        img = pyglet.image.load("Assetss/PNG/Lasers/laserRed01.png")
    ...
    def tick(self, dt):
        ...
        if "SHIFT" in pressed_keyboards and self.laser_ready:
            self.shoot()
...
class Game:
    ...
    def game_lifes(self):
        global lifes
        life = pyglet.image.load("Assetss/PNG/UI/playerLife3_orange.png")
        width = 10
    ...
    def game_end(self):
        if lifes <= 0:
            self.window.clear()
            game_objects.clear()
            lose_text = pyglet.text.Label(text="Koniec hry!", font_size=70, x=WIDTH / 2, y=HEIGHT / 2, anchor_x='center',
                                          anchor_y='center')
            lose_text.draw()
        elif score >= max_score:
            self.window.clear()
            game_objects.clear()
            win_text = pyglet.text.Label(text="Vyhral si!", font_size=70, x=WIDTH / 2, y=HEIGHT / 2, anchor_x='center',
                                         anchor_y='center')
            win_text.draw()
